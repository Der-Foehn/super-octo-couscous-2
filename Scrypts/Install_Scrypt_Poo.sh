...
#COINS
	sudo ufw allow 3636/tcp # GRV
#	sudo ufw allow 4001/tcp	# CBS
...
mkdir scrypts
cd scrypts
sudo wget https://raw.githubusercontent.com/Der-Foehn/super-octo-couscous-2/master/Scrypts/download_pool_scrypticons.sh
sudo chmod -R 775 ~/scrypts
sudo bash download_pool_scrypticons.sh
...
output " "
output "configure /var/web/serverconfig.php file."
output " "
output " "
output " "
output " "
